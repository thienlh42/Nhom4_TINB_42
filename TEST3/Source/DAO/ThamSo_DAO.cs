...
namespace DAO
{
    public class ThamSo_DAO
    {
        ...
        {
            string sql = "update THAMSO set SoLuongNhapToiThieu=" + ts.SoLuongNhapToiThieu + ",SoLuongTonToiThieu=" + ts.SoLuongTonToiThieu + ",SoLuongTonToiDa=" + ts.SoLuongTonToiDa + ",SoTienNoToiDa=" + ts.SoTienNoToiDa + ",ApDungQuyDinh4=" + ts.ApDungQuyDinh4 + " where MaThamSo = " + ts.MaThamSo + "";
            return DataAccess.ThucThiNonQuery(sql);
        }
        //Thêm mới 1 tham số
        public static string Them(ThamSo_DTO ts)
        {
            string sql = "insert into THAMSO(SoLuongNhapToiThieu,SoLuongTonToiThieu,SoLuongTonToiDa,SoTienNoToiDa,ApDungQuyDinh4) values (" + ts.SoLuongNhapToiThieu + "," + ts.SoLuongTonToiThieu + "," + ts.SoLuongTonToiDa + "," + ts.SoTienNoToiDa + "," + ts.ApDungQuyDinh4 + ")";
            return DataAccess.ThucThiNonQuery(sql);
        }
